...
2. Update `flags.json`, keeping one entry per option group with all aliases, applicable modes, value metadata, serialization rules, and a concise two-to-three-sentence description.
