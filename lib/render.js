(function (root, factory) {
    ...
    function createRenderer(document, callbacks = {}) {
        const nodes = Object.fromEntries([
            ...
            'windowsShellSelector', 'presetSelector', 'presetDescription'
        ...
        function renderPresetControl(registry, state) {
            ...
            const activePreset = presets.presetById(registry, state.activePreset);
            nodes.presetDescription.textContent = `${activePreset.description} Selecting a preset changes Essentials and replaces only recipe-specific values.`;
